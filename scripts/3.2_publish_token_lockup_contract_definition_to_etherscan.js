...
async function main () {
  ...
  await ethers.provider.waitForTransaction(deploymentInfo.tokenLockup.transaction, 5)
  ...
  await hre.run('verify:verify', {
    address: deploymentInfo.tokenLockup.address,
    constructorArguments: deploymentInfo.tokenLockup.args
  })
}
